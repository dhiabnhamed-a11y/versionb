    ...
    <div style={{ padding: 24, maxWidth: 800, margin: '0 auto' }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 20, fontWeight: 700, color: '#f1f5f9', margin: 0, display: 'flex', alignItems: 'center', gap: 8 }}>
          <Settings size={18} color="#94a3b8" /> EMS Settings
        </h1>
        <p style={{ fontSize: 13, color: '#64748b', margin: '4px 0 0' }}>Configure your emergency operations center</p>
      </div>

      <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 10, padding: 24 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          <div>
            <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#cbd5e1', marginBottom: 4 }}>Dispatch Mode</label>
            ...
            <div style={{ fontSize: 11, color: '#64748b', marginTop: 2 }}>Controls how AI dispatch decisions are applied</div>
          </div>
          <div>
          ...
          <div>
            <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#cbd5e1', marginBottom: 4 }}>Default Radio Channel</label>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#cbd5e1', marginBottom: 4 }}>AI Auto-Dispatch Threshold</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#cbd5e1', marginBottom: 4 }}>Response Time Target (seconds)</label>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              { key: 'enableAiClassification', label: 'AI Severity Classification', desc: 'Automatically classify incident severity from call data' },
              { key: 'enableAutoDispatch', label: 'AI Auto-Dispatch', desc: 'Allow AI to automatically dispatch units for high-severity incidents' },
              { key: 'enablePredictiveAlerts', label: 'Predictive Alerts', desc: 'Receive AI predictions for demand zones and incident hotspots' },
            ].map(({ key, label, desc }) => (
