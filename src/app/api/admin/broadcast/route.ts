 ...
 *
 * Send a realtime event to an entire workspace, a specific department's
 * members, or a single user. Requires MANAGER, OWNER, or SUPER_ADMIN role.
 *
 * Body:
 *   type     – canonical realtime event name
 *   payload  – arbitrary JSON payload (merged with broadcast metadata)
