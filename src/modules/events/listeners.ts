...
const REALTIME_EVENT_MAP: Partial<Record<DomainEventName, RealtimeEventName>> = {
  ...
  'finance.account.created': 'finance.account.created',
  'finance.journal_entry.created': 'finance.journal_entry.created',
  'finance.journal_entry.posted': 'finance.journal_entry.posted',
  'finance.journal_entry.reversed': 'finance.journal_entry.reversed',
